...
<div>
    ...
    <el-table :data="orderList" border style="width: 100%">
      ...
      <el-table-column label="操作"  width="180">
        <template slot-scope="scope" v-if="flag">
          ...
          <el-button @click="formVisible(scope.row)" type="primary" size="small">接受</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
  ...
  <div class="tbotton-botn" style="width:80%;height:60px;overflow: hidden; margin:0 auto;margin-top: 50%;" >
    ...
    formVisible(row) {
      ...
      this.$MessageBox
        ...
        .then(() => {
          ...
          params.append("orderId",row.hotelOrderId);
          this.$axios
            .post("/backstage/hotelOrder/updateStatus", params, {})
            .then(response => {
              that.Page = 1;
