<template>
  <div class="merchenttop">
    ...
    >
      ...
      <el-form-item class="werchent-item" prop="hotelName" label="房型名称">
        <el-input
          class="merchent-inpout"
          style="width:60%;"
          placeholder="请输入内容"
          v-model="merchenFrom.roomType"
        ></el-input>
      </el-form-item>
      <el-form-item class="werchent-item" prop="hotelName" label="加价">
        <el-input
          class="merchent-inpout"
          style="width:20%;"
          placeholder="请输入内容"
          v-model="merchenFrom.price"
        ></el-input>
      </el-form-item>
      <el-form-item label="库存数量" prop="roomNum">
...
export default {
  ...
  mounted: function() {
    this.merchenFrom.hotelName = this.$route.query.hotelName;
    ...
    onSubmitto() {
      ...
      if (this.merchenFrom.hotelName !== "") {
        ...
        let repertoryVo = JSON.stringify({
          ...
          endDate: endDate,
          merchantId: userName,
          name: this.merchenFrom.roomType,
          price:this.merchenFrom.price
        });
        params.append("repertory", repertoryVo);
        params.append("changeArr", JSON.stringify(this.changeArr));
        params.append("hotelId",  that.hotelId);
        this.$axios
          .post("/backstage/repertory/addroomType", params, {})
          .then(resp => {
